            ...
            <div className="max-w-6xl mx-auto px-6 lg:px-12">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-10">
                    <div className="bg-white p-8 rounded-xl shadow border border-steel/30">
                        <h3 className="text-xl font-bold mb-4">Metal Fabrication</h3>
                    ...
                    <div className="bg-white p-8 rounded-xl shadow border border-steel/30">
                        <h3 className="text-xl font-bold mb-4">Security Installations</h3>
                        <p className="text-gray-700">
                    ...
                    <div className="bg-white p-8 rounded-xl shadow border border-steel/30">
                        <h3 className="text-xl font-bold mb-4">Structural Steel Works</h3>
                        <p className="text-gray-700">
                    ...
                    <div className="bg-white p-8 rounded-xl shadow border border-steel/30">
                        <h3 className="text-xl font-bold mb-4">Gate & Fence Fabrication</h3>
                        <p className="text-gray-700">
                    ...
                    <div className="bg-white p-8 rounded-xl shadow border border-steel/30">
                        <h3 className="text-xl font-bold mb-4">Construction Support</h3>
                        <p className="text-gray-700">
