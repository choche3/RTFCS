...
export default function MapPlaceholder () {
    return(
        <motion.section 
            ...
            whileInView="show"
            viewport={{ once: true }}
            className="bg-steel/10"
            >
                <motion.h3 
                variants={fadeUp}
                    className="mb-5 max-w-4xl mx-auto px-6 py-6">Our Lusaka office Address
                </motion.h3>
                <motion.iframe
                    variants={fadeUp}
                    ...
                    <motion.div 
                    variants={fadeUp}
                    className="max-w-4xl mx-auto px-6 mt-1 mb-1">
                        <a 
                    ...
                    <motion.div 
                        variants={fadeUp}
                        className="max-w-4xl mx-auto px-6 mt-1 mb-6">
                            <a
